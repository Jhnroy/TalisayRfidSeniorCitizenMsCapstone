...
const DswdValidation = () => {
    ...
    if (search.trim() !== "") {
      ...
      data = data.filter(
        (row) =>
          ...
          row.seniorId.toLowerCase().includes(s)
      );
    }
  ...
  }, [search, barangayFilter, statusFilter, nameSort, records, loading]);
  ...
  const handleValidation = async (status) => {
    ...
    if (selectedRecord.hasPension && status === "Eligible") {
      alert("This senior already has an existing pension.");
      return;
    }
    ...
    try {
      ...
      await push(notifRef, {
        message: `Senior ${selectedRecord.name} marked as ${status}.`,
        read: false,
    ...
    <div className="p-4 w-full overflow-x-auto">
      ...
      <div className="flex flex-col md:flex-row gap-2 md:gap-4 mb-4 items-start md:items-center">
        <input
          ...
          className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 w-full md:w-1/3"
        />
      ...
      <div className="overflow-x-auto">
        {loading ? (
          ...
          <p className="p-4 text-center text-gray-500">No matching records.</p>
        ) : (
          <table className="min-w-full border border-gray-200 rounded-lg">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 border-b">Registration</th>
            ...
            <tbody>
              {filteredData.map((item, idx) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 font-semibold text-orange-500">
      ...
      {documentModal.show && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-30">
          <div className="bg-white p-4 rounded-lg w-[90%] md:w-[70%] lg:w-[50%] max-h-[90vh] overflow-auto relative">
            <button
