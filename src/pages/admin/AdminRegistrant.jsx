      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 border-b border-gray-200 pb-6 gap-4">
          <div className="flex items-center space-x-4">
            ...
            {/* Title Section */}
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Senior Citizen Registration</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <label htmlFor="seniorId" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="barangayCertificate" className="block text-sm font-medium text-gray-700 mb-1">
                  Upload Barangay Certificate <span className="text-red-500">*</span>
                </label>
                <p className="text-sm text-gray-500 mb-2">PDF, JPG or PNG (Max 5MB)</p>
                <input
                  type="file"
          ...
          <div className="p-6">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-gray-700 mb-4">
                I confirm that the senior citizen has given consent for their personal information to be collected and processed in accordance with <strong>IniColds Privacy Act</strong>. This includes the collection, storage, and processing of personal data for the purpose of senior citizen services and benefits.
              </p>
          ...
          <div className="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row justify-end gap-3">
            <button
              ...
              className="w-full sm:w-auto px-6 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="w-full sm:w-auto px-6 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
            >
